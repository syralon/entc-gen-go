...
func (_q *UserQuery) QueryUserGroups() *GroupQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, user.UserGroupsTable, user.UserGroupsPrimaryKey...),
		)
...
func (_q *UserQuery) WithUserGroups(opts ...func(*GroupQuery)) *UserQuery {
	query := (&GroupClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withUserGroups; query != nil {
		if err := _q.loadUserGroups(ctx, query, nodes,
			func(n *User) { n.Edges.UserGroups = []*Group{} },
			func(n *User, e *Group) { n.Edges.UserGroups = append(n.Edges.UserGroups, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadUserGroups(ctx context.Context, query *GroupQuery, nodes []*User, init func(*User), assign func(*User, *Group)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(group.FieldID), joinT.C(user.UserGroupsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.UserGroupsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.UserGroupsPrimaryKey[0]))
