...
import (
	...
	"github.com/syralon/entc-gen-go/example/ent/migrate"
...
func (c *GroupClient) QueryGroupUsers(_m *Group) *UserQuery {
...
func (c *UserClient) QueryUserGroups(_m *User) *GroupQuery {
