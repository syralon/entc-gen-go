...
type GroupEdges struct {
	...
	GroupUsers []*User `json:"group_users,omitempty"`
...
func (e GroupEdges) GroupUsersOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
...
func (_m *Group) QueryGroupUsers() *UserQuery {
	return NewGroupClient(_m.config).QueryGroupUsers(_m)
}
