...
func LeadingComment(comment string) protobuilder.Comments {
	return protobuilder.Comments{LeadingComment: comment}
}
...
var EntityTypeMapping typeMapping = map[field.Type]*protobuilder.FieldType{
...
var OperationTypeMapping typeMapping = map[field.Type]*protobuilder.FieldType{
